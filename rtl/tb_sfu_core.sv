...
module tb_sfu_core;
  ...
  always_comb begin
    // Values generated by tests/sfu_model_sweep.py for the input vector below.
    // Keep this independent of the pipelined RTL lane so the test catches a
    // stage-to-stage data/control misalignment.
    if (subop_i == 3'd0) begin
      reference_data[0] = 32'h3f7ff800;
      reference_data[1] = 32'h3efff800;
      reference_data[2] = 32'h3eaaa71d;
      reference_data[3] = 32'h3e7ff800;
      reference_data[4] = 32'hbf7ff800;
      reference_data[5] = 32'h7f800000;
      reference_data[6] = 32'h00000000;
      reference_data[7] = 32'h7fc00000;
    end else begin
      reference_data[0] = 32'h40000000;
      reference_data[1] = 32'h40800000;
      reference_data[2] = 32'h41000000;
      reference_data[3] = 32'h41800000;
      reference_data[4] = 32'h3f000000;
      reference_data[5] = 32'h3f800000;
      reference_data[6] = 32'h7f800000;
      reference_data[7] = 32'h7fc00000;
    end
  end
