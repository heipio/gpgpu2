...
module vrf_lane (
  ...
  localparam int VRF_DEPTH = 1024;

  logic [9:0] read_addr1;
  logic [9:0] read_addr2;
  logic [9:0] read_addr3;
  ...
  assign read_addr1 = {read_reg1_i, read_beat_i};
  assign read_addr2 = {read_reg2_i, read_beat_i};
  assign read_addr3 = {read_reg3_i, read_beat_i};
  assign write_addr = {write_reg_i, write_beat_i};
