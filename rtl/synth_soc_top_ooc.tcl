...
create_project -in_memory aec_soc_ooc -part xcu280-fsvh2892-2L-e
...
synth_design -top aec_soc_top -part xcu280-fsvh2892-2L-e -mode out_of_context
...
report_utilization -file soc_top_ooc_utilization.rpt
report_timing_summary -file soc_top_ooc_timing_summary.rpt
puts "SYNTH_SOC_TOP_OOC_PASS"
